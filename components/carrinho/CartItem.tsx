        ...
        <div className="flex items-center justify-between mt-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full border border-gray-200 text-gray-600 hover:border-blue-400 hover:text-blue-700 text-lg font-medium transition flex items-center justify-center"
            >
              −
            </button>
            ...
            <button
              ...
              className="w-8 h-8 rounded-full border border-gray-200 text-gray-600 hover:border-blue-400 hover:text-blue-700 text-lg font-medium transition flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed"
            >
              +
            </button>

...
import CartIcon from '@/components/carrinho/CartIcon';
        ...
        <div className="flex items-center gap-3">
          {WA_NUMERO && (
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 text-sm text-gray-500 hover:text-green-600 transition"
            >
              {/* ícone WhatsApp mini */}
